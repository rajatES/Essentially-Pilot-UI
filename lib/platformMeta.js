...
// How a post entered the system. "app" is the norm and gets no badge; the rest
// are surfaced so API/CSV/recycled posts are distinguishable at a glance.
export const SOURCE_META = {
  api:     { label: "API",      cls: "bg-violet-50 dark:bg-violet-500/10 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-500/30" },
  csv:     { label: "CSV",      cls: "bg-sky-50 dark:bg-sky-500/10 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-500/30" },
  recycle: { label: "Recycled", cls: "bg-teal-50 dark:bg-teal-500/10 text-teal-700 dark:text-teal-300 border border-teal-200 dark:border-teal-500/30" },
};

// Returns { label, cls } for a non-default source, else null (no badge for "app").
